...
<template>
  <div>
    ...
    <Section :menu="`events`">
      週に1回、早稲田大学理工キャンパス61号館1階 <a class="underline text-teal-500 hover:text-teal-500" href="https://www.koubou.sci.waseda.ac.jp/summary/LearningCommons61.html"> ラーニング・コモンズ</a> にてミーティングを行います。
