    ...
    <div class="flex justify-between items-center py-2 md:py-4">
      ...
      <div class="hidden md:block">
        <ul class="flex space-x-8 text-sm font-sans">
          ...
          <li>
            <a href="https://forms.gle/d9vutEpNdFtSLneZA" target="_blank" class="bg-gray-200 hover:bg-gray-300 focus-visible:ring ring-teal-300 text-gray-500 active:text-gray-700 text-sm md:text-2xl font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">お問い合わせ</a>
          </li>
        </ul>
      </div>
